...
const initialDocs: DocumentItem[] = [
  {
    ...
    date: "01 Juli 2026",
    amountDisplay: "Rp 97.500.000",
    status: "Sah & Diverifikasi",
    targetUrl: "/dokumen/invoice/BK-2407-001",
    phone: "0812-4455-7788",
    badgeColor: "bg-purple-50 text-purple-800 border-purple-200/60",
  },
  {
    id: "doc-002",
    number: "KW-2407-044",
  ...
  },
  {
    ...
    date: "03 Juli 2026",
    amountDisplay: "Rp 69.000.000",
    status: "Pending Pelunasan",
    targetUrl: "/dokumen/invoice/BK-2407-002",
  ...
  {
    id: "doc-005",
    number: "MNF-GA980-08JUL",
    type: "Manifest Flight",
    customerName: "Rombongan Bangka Belitung 08 Jul",
    bookingCode: "SCHEDULE-GA980",
    date: "08 Juli 2026",
    amountDisplay: "40 Pax Jamaah",
    status: "Sah & Diverifikasi",
    targetUrl: "/manifest",
    phone: "0812-4455-7788",
    badgeColor: "bg-sky-50 text-sky-800 border-sky-200/60",
  },
  {
    id: "doc-006",
    number: "SRT-PASPOR-0826",
    type: "Surat Rekomendasi Paspor",
    customerName: "Ahmad Hidayat",
    bookingCode: "BK-2407-002",
    date: "15 Juli 2026",
    amountDisplay: "Izin PPIU Kemenag",
    status: "Sah & Diverifikasi",
    targetUrl: "/manifest",
    phone: "0813-8899-1122",
